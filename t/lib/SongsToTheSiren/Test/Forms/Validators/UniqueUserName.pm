package SongsToTheSiren::Test::Forms::Validators::UniqueUserName;
use utf8;
use Moose;
...
use SongsToTheSiren::Form::Field::Validator::UniqueUserName;
...
sub run {
	...
	my $validator = SongsToTheSiren::Form::Field::Validator::UniqueUserName->new(schema => $self->schema);
