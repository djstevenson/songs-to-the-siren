package SongsToTheSiren::Test::Forms::Validators::UniqueUserEmail;
use utf8;
use Moose;
...
use SongsToTheSiren::Form::Field::Validator::UniqueUserEmail;
...
sub run {
	...
	my $validator = SongsToTheSiren::Form::Field::Validator::UniqueUserEmail->new(schema => $self->schema);
