package SongsToTheSiren::Test::Forms::Validators::ValidEmail;
use utf8;
use Moose;
...
use SongsToTheSiren::Form::Field::Validator::ValidEmail;
...
sub run {
	...
	my $validator = SongsToTheSiren::Form::Field::Validator::ValidEmail->new(schema => $self->schema);
