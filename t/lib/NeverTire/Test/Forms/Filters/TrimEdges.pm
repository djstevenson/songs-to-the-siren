package NeverTire::Test::Forms::Filters::TrimEdges;
use Moose;
...
use NeverTire::Form::Field::Filter::TrimEdges;
...
sub run {
	...
	my $filter = NeverTire::Form::Field::Filter::TrimEdges->new(schema => $self->schema);
