package NeverTire::Test::Forms::Validators::ValidInteger;
use Moose;
...
use NeverTire::Form::Field::Validator::ValidInteger;
...
sub run {
	...
	my $validator = NeverTire::Form::Field::Validator::ValidInteger->new(schema => $self->schema);
