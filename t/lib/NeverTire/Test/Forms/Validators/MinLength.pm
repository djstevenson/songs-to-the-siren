package NeverTire::Test::Forms::Validators::MinLength;
use Moose;
...
use NeverTire::Form::Field::Validator::MinLength;
...
sub run {
	...
	foreach my $test (@$tests){
		my $min = $test->{min};
		my $validator = NeverTire::Form::Field::Validator::MinLength->new(min => $min, schema => $self->schema);
