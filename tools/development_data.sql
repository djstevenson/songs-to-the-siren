...
('The Dears', 'Lost in the Plot', 'No Cities Left',  'lost-in-the-plot', 'CA',
...
INSERT INTO songs (artist,title,album,"image",country,summary_markdown,summary_html,full_markdown,full_html,author_id,created_at,updated_at,released_at,published_at) VALUES
('Flowered Up', 'It''s On', 'A Life with Brian, 1991', 'its-on', 'UK',
'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
INSERT INTO songs (artist,title,album,"image",country,summary_markdown,summary_html,full_markdown,full_html,author_id,created_at,updated_at,released_at,published_at) VALUES
('Throwing Muses', 'Fish', 'Lonely Is An Eyesore (various artists)', 'lonely-is-an-eyesore', 'US',
'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
Ut enim ad minim veniam.',
'<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><p>Ut enim ad minim veniam</p>',
'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
INSERT INTO songs (artist,title,album,"image",country,summary_markdown,summary_html,full_markdown,full_html,author_id,created_at,updated_at,released_at,published_at) VALUES
('The Heart Throbs', 'Tiny Feet', 'Jubilee Twist', 'jubilee-twist', 'UK',
...
INSERT INTO songs (artist,title,album,"image",country,summary_markdown,summary_html,full_markdown,full_html,author_id,created_at,updated_at,released_at,published_at) VALUES
('Pixies', 'Planet of Sound', 'Trompe le Monde', 'planet-of-sound', 'US',
...
INSERT INTO songs (artist,title,album,"image",country,summary_markdown,summary_html,full_markdown,full_html,author_id,created_at,updated_at,released_at,published_at) VALUES
('This Mortal Coil', 'Song to the Siren', 'It''ll End in Tears', 'song-to-the-siren', 'UK',
'I met this guy in a rover...',
'<p>I met this guy in a rover...</p>',
