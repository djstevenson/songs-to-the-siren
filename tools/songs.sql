INSERT INTO songs (artist,title,album,summary_markdown,summary_html,full_markdown,full_html,author_id,date_created,date_updated,date_released,date_published) VALUES ('Throwing Muses (USA)', 'Fish', 'Lonely Is An Eyesore (various artists)',
...
INSERT INTO songs (artist,title,album,summary_markdown,summary_html,full_markdown,full_html,author_id,date_created,date_updated,date_released,date_published) VALUES ('The Heart Throbs (UK)', 'Tiny Feet (my own edit!)', 'Jubilee Twist',
